...
public class TRss {
  ...
  protected transient List<TRssChannel> channel;
  @XmlAnyElement(lax = true)
  protected transient List<Object> any;
  @XmlAttribute(name = "version", required = true)
  protected transient BigDecimal version;
  @XmlAnyAttribute
  private final transient Map<QName, String> otherAttributes = new HashMap<QName, String>();
